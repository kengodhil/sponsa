...
class Payment(models.Model):
    ...
    provider_result = models.CharField(max_length=40, blank=True)
    provider_message = models.TextField(blank=True)
    selcom_reference = models.CharField(max_length=120, blank=True)
